...
def carpk_get_argparser():

    parser = argparse.ArgumentParser("MMAF parser", add_help=False)

    parser.add_argument('--model_name', default='MMFA150_3_shot_nocars', type=str)

    parser.add_argument(
        '--data_path',
        default = '/data/xxx/datasets/CARPK',
        type=str
    )
    ...
    parser.add_argument('--num_objects', default=1, type=int)
